...
public class ScanPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  private void configChannel(ActivityPluginBinding binding) {
    ...
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "io.improvising/scan");
    channel.setMethodCallHandler(this);
    flutterPluginBinding.getPlatformViewRegistry()
            .registerViewFactory("io.improvising/scan_view", new ScanViewFactory(
  ...
  private String getCodeFromImagePath(String path) {
    ...
    final List<BarcodeFormat> allFormats = new ArrayList<>();
