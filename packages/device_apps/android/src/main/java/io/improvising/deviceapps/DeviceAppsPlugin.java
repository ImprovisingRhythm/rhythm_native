...
import io.improvising.deviceapps.listener.DeviceAppsChangedListener;
import io.improvising.deviceapps.listener.DeviceAppsChangedListenerInterface;
import io.improvising.deviceapps.utils.AppDataConstants;
import io.improvising.deviceapps.utils.AppDataEventConstants;
import io.improvising.deviceapps.utils.IntentUtils;
...
import static io.improvising.deviceapps.utils.Base64Utils.encodeToBase64;
import static io.improvising.deviceapps.utils.DrawableUtils.getBitmapFromDrawable;
...
public class DeviceAppsPlugin implements
        ...
        switch (call.method) {
            ...
            case "openApp":
                if (!call.hasArgument("package_name") || TextUtils.isEmpty(call.argument("package_name").toString())) {
                    ...
                    result.success(openApp(packageName, data));
                }
                break;
    ...
    private boolean openApp(@NonNull String packageName, String data) {
    ...
    private Map<String, Object> getAppData(PackageManager packageManager,
        ...
        map.put(AppDataConstants.VERSION_CODE, (int) pInfo.getLongVersionCode());
