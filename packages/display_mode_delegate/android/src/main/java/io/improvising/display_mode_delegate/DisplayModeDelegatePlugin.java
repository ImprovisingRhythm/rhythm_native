package io.improvising.display_mode_delegate;
 ...
 * DisplayModePlugin
 */
public class DisplayModeDelegatePlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        final MethodChannel channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "rhythm_native/display_mode_delegate");
